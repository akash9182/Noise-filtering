...
CUDA_VISIBLE_DEVICES="1,2,3" python3 main.py --init_noise_std 0. --save_path segan_allbiased_preemph \
                                          --init_l1_weight 100. --batch_size 2 --g_nl prelu \
                                          --save_freq 50 --preemph 0.95 --epoch 2 --bias_deconv True \
